      ...
      <div className="w-full lg:w-80 space-y-8">
        ...
        <div className="bg-[#111113] border border-[#1A1A1F] rounded-2xl p-8 flex flex-col h-[500px]">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/focus" className="text-[10px] font-bold text-[var(--accent)] uppercase tracking-widest hover:underline">View All</Link>
          </div>
          ...
          <Link href="/focus" className="mt-8 w-full py-3 border border-dashed border-[#27272A] rounded-xl text-[var(--text-muted)] text-[10px] font-bold uppercase tracking-widest hover:border-[var(--accent)]/50 hover:text-[var(--text-primary)] transition-all flex items-center justify-center gap-2">
